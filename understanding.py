...
INTENT_EXAMPLES: dict[str, list[str]] = {
    ...
    "player_champion_mastery": ["이 선수가 저 챔프 잘해?", "저 챔피언 장인이야?",
                                 "이 선수 원챔이지?", "시그니처 픽 뭐야?"],
